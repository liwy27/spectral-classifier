...
tf.app.flags.DEFINE_integer('batch_size', 4, 'Instance count in a batch.')
tf.app.flags.DEFINE_integer('train_num_epochs', 20, 'Iteration count over training data.')
...
def main(_):
    ...
    run_config = tf.estimator.RunConfig(keep_checkpoint_max=1, save_checkpoints_steps=10, log_step_count_steps=10)
